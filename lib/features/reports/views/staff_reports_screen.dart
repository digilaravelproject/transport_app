...
class StaffReportsScreen extends GetView<ReportsController> {
  const StaffReportsScreen({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    final reports = controller.recentReports.where((r) => r.type == 'Performance').toList();
    ...
    return AppScaffold(
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          children: [
             if (reports.isEmpty)
                const Center(child: Padding(padding: EdgeInsets.all(32), child: AppText('No staff reports found.')))
             else
                ListView.builder(
                  shrinkWrap: true,
